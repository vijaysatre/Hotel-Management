...
class Registration
{
	...
	Registration reg() throws InterruptedException
	{
		...
		return new Registration(age,member,name,add,gender,aadhar_no,date_in,data_out,rly,flag,mobile_no,room_no,rooms,ch_rooms);
	}
...
public class Hotel
{
	public static void main(String args[])
	{
		...
		Registration regi=new Registration(0,"Name",0);
		...
		do
		{
			...
			switch(choice)
			{
				...
				case 3:
				System.out.println("Please Enter the Aadhar Card Number");
				String index=in.nextLine();
				for(Registration i:registration)
				{
					if(index==i.aadhar_no)
					{
								System.out.println("Name "+i.name);
								System.out.println("Age "+i.age);
								System.out.println("Gender "+i.gender);
